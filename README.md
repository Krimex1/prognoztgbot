...
⚠️ **Важно!** Никогда не коммитьте файлы с секретами:

- ✅ Используйте `.env` для API ключей
- ✅ Добавьте `.env` в `.gitignore`
- ✅ Используйте `.env.example` как шаблон

## 🤝 Вклад в проект

Буду рад любому вкладу! Если есть идеи или нашли баг:
...
- Website: [d1.litehosting.su](http://d1.litehosting.su:25603/)
...
[![Telegram](https://img.shields.io/badge/Telegram-@krimexAI-blue?style=social&logo=telegram)](https://t.me/krimexAI)
